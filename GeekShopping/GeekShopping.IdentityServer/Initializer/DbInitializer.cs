...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "amarildo-admin",
                Email = "abreu-admin@outlook.com",
                EmailConfirmed = true,
                PhoneNumber = "+244 930549221",
                FirstName = "Amarildo",
                LastName = "Admin"
            };

            _user.CreateAsync(admin, "Amarildo@123").GetAwaiter().GetResult();
            ...
            {
                UserName = "amarildo-client",
                Email = "abreu-client@outlook.com",
                EmailConfirmed = true,
                PhoneNumber = "+244 930549221",
                FirstName = "Amarildo",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Amarildo@123").GetAwaiter().GetResult();
